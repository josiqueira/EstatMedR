...
cat(bartitle("Estimated marginal means"))
cat(bartitle("TamanhoGrupo",2))
EMM.A <- emmeans::emmeans(modelo, pairwise ~ TamanhoGrupo)
print(EMM.A$emmeans)
print(plot(EMM.A$emmeans,
           colors = "black", xlab="Ideias"))
cat(bartitle("Profissional",2))
EMM.C <- emmeans::emmeans(modelo, pairwise ~ Profissional)
print(EMM.C$emmeans)
print(plot(EMM.C$emmeans,
           colors = "black", xlab="Ideias"))
cat(bartitle("TamanhoGrupo and Profissional",2))
EMM.AC <- emmeans::emmeans(modelo, pairwise ~ TamanhoGrupo:Profissional)
print(EMM.AC$emmeans)
