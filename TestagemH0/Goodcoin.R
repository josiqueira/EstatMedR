...
if (valor_a_receber=="") {valor_a_receber <- 10000; cat("default: ",valor_a_receber,"\n",sep="")}
...
if (jogadasporvez=="") {jogadasporvez <- 15; cat("default: ",jogadasporvez,"\n",sep="")}
...
if (alfa=="") {alfa <- 0.05; cat("default: ",alfa,"\n",sep="")}
...
if (prob_coroa_H0=="") {prob_coroa_H0 <- 0.5; cat("default: ",prob_coroa_H0,"\n",sep="")}
prob_coroa_H0 <- as.numeric(prob_coroa_H0)

# para sair coroa H1
cat ("\nAs moedas falsas tem outro balanceamento.\n")  
cat ("(para simular, forneca uma probabilidade diferente de",prob_coroa_H0,"\n")
...
cat ("(numero entre 0 e 1).\n") 
prob_coroa_H1 <-readline(prompt=paste("P[coroa|H1] (default=nao simular): ",sep=""))
if (prob_coroa_H1=="") {prob_coroa_H1 <- prob_coroa_H0; cat("default: nao simular\n",sep="")}
...
cat ("Valor para alfa mais proximo do alfa solicitado = ", alfa_teorico,"%\n")
...
cat ("(este eh o Intervalo de Confianca",
     round(100-alfa_teorico,2),
     "% centrado em H0: P=",prob_coroa_H0,")\n")
...
for (i in 1:(valor_a_receber/divide))
{
  ...
  if  ( (i %% exibegrf) == 0 || i <= 100 || i == (valor_a_receber/divide) )
  {
    ...
    txtH0 <- paste("H0: P=",prob_coroa_H0,sep="")
    txtH1 <- paste("H1: P=",prob_coroa_H1,sep="")
    if(prob_coroa_H1 == prob_coroa_H0)
    {
...
cat ("(este eh o Intervalo de Confianca",round(100-alfa_teorico,2),"% centrado em H0: P=",prob_coroa_H0,")\n")
