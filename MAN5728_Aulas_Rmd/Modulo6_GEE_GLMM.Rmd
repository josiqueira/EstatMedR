...
knitr::include_graphics("./image/GEExGLMM.png")
```
...
knitr::include_graphics("./image/Fig31.png")
```

```{r eval=TRUE, echo=FALSE, out.width="100%", fig.cap="Sainani, 2010, p. 861."}
knitr::include_graphics("./image/Table5.png")
```
...
knitr::include_graphics("./image/Correlation_examples2.png")
```
...
knitr::include_graphics("./image/pHi.png")
```
...
knitr::include_graphics("./image/r_intra_wrong.png")
```
...
knitr::include_graphics("./image/Fig33.png")
```
