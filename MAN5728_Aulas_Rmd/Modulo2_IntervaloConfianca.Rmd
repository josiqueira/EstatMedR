...
```{r eval=TRUE, echo=FALSE, warning=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("./image/World100.png")
```
...
knitr::include_graphics("./image/sd_se.png")
```
...
knitr::include_graphics("./image/normais.png")
```
...
```{r fig.align="center", out.width = '80%', out.height = '70%', echo=FALSE}
knitr::include_graphics("./image/normalstandard.png")
```

```{r fig.align="center", out.width = '80%', out.height = '70%', echo=FALSE}
knitr::include_graphics("./image/normalstandard1.png")
```
...
knitr::include_graphics("./image/TCL0.png")
```

```{r eval=TRUE, echo=FALSE, warning=FALSE, out.width="70%", fig.align="left"}
knitr::include_graphics("./image/TCL1.png")
```

```{r eval=TRUE, echo=FALSE, warning=FALSE, out.width="70%", fig.align="left"}
knitr::include_graphics("./image/TCLnormal.png")
```
...
```{r eval=TRUE, echo=FALSE, warning=FALSE, out.width="70%", fig.align="left"}
knitr::include_graphics("./image/boot.png")
```
